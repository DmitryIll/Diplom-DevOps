...
backend "s3" {
    ...
    dynamodb_table = "tflock-dip"
     dynamodb_endpoint = "https://docapi.serverless.yandexcloud.net/ru-central1/b1gq7flktn6couidedto/etnisf1utd8alm2iftmt"
...
provider "aws" {
  ...
  endpoints {
    dynamodb = "https://docapi.serverless.yandexcloud.net/ru-central1/b1gq7flktn6couidedto/etnisf1utd8alm2iftmt"
  }
